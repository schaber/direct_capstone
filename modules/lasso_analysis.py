...
class PlastPredictor():
    ...
    def fit_model(self, pl_data, org_data, upsample=True, downsample=False):
        ...
        self.clf = GridSearchCV(lasso, parameters, verbose=1, scoring='neg_mean_squared_error', cv = 5)
    ...
    def predict(self, X, type='prob', class_id='pos'):
        ...
        # assert self.clf.alpha.shape[1] == X.shape[1], "ERROR: Input data must have same number of features as training sets"
